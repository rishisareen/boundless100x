...
FLAG_LABELS: dict[str, tuple[str, str]] = {
    ...
    "capital_partly_undeployed": ("Retained Capital Not Yet Deployed", "neutral"),
    ...
    "fcf_adjusted_for_treasury": (
        "Free Cash Flow Adjusted for Treasury Deployment", "neutral"
    ),
...
FLAG_ELEMENT_MAP: dict[str, str] = {
    ...
    "capital_partly_undeployed": "quality_business",
    ...
    "fcf_adjusted_for_treasury": "price",
